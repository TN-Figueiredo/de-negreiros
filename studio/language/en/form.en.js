...
export const INPUT_MESSAGE_TITLE_DESCRIPTION = "Label for field message";
export const INPUT_MESSAGE_PLACEHOLDER_TITLE = "Placeholder";
export const INPUT_MESSAGE_PLACEHOLDER_DESCRIPTION = "Placeholder for message";

// inputSelect.js
export const INPUT_SELECT_TITLE = "Select";
export const INPUT_SELECT_TITLE_TITLE = "Title of select field";
export const INPUT_SELECT_TITLE_DESCRIPTION = "Label for select field";
export const INPUT_SELECT_OPTIONS_TITLE = "Options of select";
