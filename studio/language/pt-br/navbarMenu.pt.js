...
export const NAVBAR_MENU_ITEM_TITLE = "Item do menu de navegação";
export const NAVBAR_MENU_IDENTIFIER_TITLE = "Identificador";
export const NAVBAR_MENU_IDENTIFIER_DESCRIPTION =
  "O identificador de um item de menu pode ser usado como um menu pai de outro item de menu";

export const NAVBAR_MENU_TITLE_TITLE = "Título";
export const NAVBAR_MENU_TITLE_DESCRIPTION = "O título do item de menu";
